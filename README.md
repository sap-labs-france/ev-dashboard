# Charge Angels Angular Dashboard App

## Summary

The Angular dashboard connects to the [Charge Angels NodeJs Server](https://github.com/sap-labs-france/ev-server) to display the charging stations in real time.
