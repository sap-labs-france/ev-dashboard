...
export class TableRefreshAssetAction extends TableRefreshAction {
  public getActionDef(): TableActionDef {
    return {
      ...super.getActionDef(),
      id: AssetButtonAction.REFRESH_ASSET_CONNECTION,
      action: this.refreshAssetConnection,
    };
  }

  private refreshAssetConnection(asset: Asset, spinnerService: SpinnerService,
