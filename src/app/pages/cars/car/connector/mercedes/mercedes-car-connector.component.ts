...
@Component({
  selector: 'app-mercedes-car-connector',
  templateUrl: 'mercedes-car-connector.component.html',
})
export class MercedesCarConnectorComponent implements OnInit, OnChanges {
