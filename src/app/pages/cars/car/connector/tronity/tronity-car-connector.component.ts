...
@Component({
  selector: 'app-tronity-car-connector',
  templateUrl: 'tronity-car-connector.component.html',
})
export class TronityCarConnectorComponent implements OnInit, OnChanges {
