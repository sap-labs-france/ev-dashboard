...
@Component({
  selector: 'app-charging-stations-parameters',
  templateUrl: './charging-stations-parameters.html'
})
@Injectable()
export class ChargingStationsParametersComponent implements OnInit {
