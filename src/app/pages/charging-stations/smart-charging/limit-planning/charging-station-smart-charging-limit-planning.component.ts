...
import { ChargingStationSmartChargingLimitChartComponent } from './charging-station-smart-charging-limit-chart.component';
...
export class ChargingStationSmartChargingLimitPlanningComponent implements OnInit {
  ...
  @ViewChild('limitChart', { static: false }) limitChartPlanningComponnent: ChargingStationSmartChargingLimitChartComponent;
  private messages;
    ...
    for (const compositeSchedule of compositeScheduleAccepted) {
      ...
      if (compositeSchedule.chargingSchedule) {
        ...
        this.minChargingRate = (compositeSchedule.chargingSchedule.minChargingRate ?
          ChargingStationSmartChargingUtils.getDisplayedFormatValue(compositeSchedule.chargingSchedule.minChargingRate,
        ...
        for (let index = 0; index < compositeSchedule.chargingSchedule.chargingSchedulePeriod.length; index++) {
          ...
          slot.limit = ChargingStationSmartChargingUtils.getDisplayedFormatValue(chargingPeriod.limit,
            compositeSchedule.chargingSchedule.chargingRateUnit,
            DISPLAY_UNIT,
            this.powerDigitPrecision,
            this.powerFloatingPrecision,
          ...
          if (index === 0) {
            ...
            this.internalFormatCurrentLimit += ChargingStationSmartChargingUtils.getInternalFormatValue(chargingPeriod.limit,
              compositeSchedule.chargingSchedule.chargingRateUnit,
              this.charger.numberOfConnectedPhase);
          }
        ...
        if (!connectorSchedule.slots || connectorSchedule.slots.length === 0) {
          this.hasNoActivePlanning = true;
          this.currentDisplayedLimit = ChargingStationSmartChargingUtils.getDisplayedFormatValue(this.charger.maximumPower,
            'W',
            DISPLAY_UNIT,
            this.powerDigitPrecision,
            this.powerFloatingPrecision,
            ...
            this.appUnitFormatter,
            true);
          this.internalFormatCurrentLimit = ChargingStationSmartChargingUtils.getInternalFormatValue(this.charger.maximumPower,
            'W',
            this.charger.numberOfConnectedPhase);
