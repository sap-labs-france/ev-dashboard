...
export class SitesListTableDataSource extends TableDataSource<Site> {
  ...
  public buildTableActionsDef(): TableActionDef[] {
    ...
    if (this.authorizationService.canAccess(Entities.SITE, Constants.ACTION_CREATE)) {
      return [
  ...
  buildTableDynamicRowActions(site: Site) {
    ...
    if (this.authorizationService.canAccess(Entities.SITE, Constants.ACTION_DELETE)) {
