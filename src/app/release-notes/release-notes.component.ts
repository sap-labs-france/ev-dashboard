        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              ` Catalog list loading performance improvement`,
        ...
        componentChanges: [
          {
            name: 'Dashboard',
            changes: [
              ` images are retrieved asynchronously`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Disabled in SAP Smart Charging the check of the three phases  on single phase Charging Station`,
              ...
              `Add more columns to distinguish between same  makers/models/versions in  selection pop-up`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Added Converter selection in  Management`,
        ...
        componentChanges: [
          {
            name: 'Dashboard',
            changes: [
              `Limit the max power of the 'safe'  to the power of the connector in the SAP Smart Charging`,
              `Auto-detect single phase  in SAP Smart Charging using new Meter Values per phase`,
              ...
              `Admin and Basic users can create s`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Added missing auto-refresh button in Assets, s and  Catalog`,
        ...
        componentChanges: [
          {
            name: 'Dashboard',
            changes: [
              `Increased Safe  power limitation in Smart Charging to not limit them on DC charging stations`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Add Default, Company and Private  information for end-user`,
        ...
        componentChanges: [
          {
            name: 'Dashboard',
            changes: [
              `Create a new  for Basic user 1/2`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Display 400V in 's converter voltage column when there are 3 phases`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Optimized  images loading management`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              ` structure adaptation for internal converters`,
              `Add  synchronization in Master tenant`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Added import of s from EV-Database via scheduled job`,
              `Enable  component in the Tenant Management`,
              `Notification of failed  synchronisation is sent to the Super Admin Users`,
