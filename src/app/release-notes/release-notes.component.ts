        ...
        componentChanges: [
          {
            name: 'Dashboard',
            changes: [
              `Charging Stations are registered with a token generated by an Admin or a Site Admin user`,
