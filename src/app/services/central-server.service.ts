...
import { ActionsResponse, ActionResponse, BillingConnectionStatusResponse, DataResult, LoginResponse, Ordering, OCPIGenerateLocalTokenResponse, OCPIJobStatusesResponse, OCPIPingResponse, OCPITriggerJobsResponse, Paging, SynchronizeResponse } from 'app/types/DataResult';
...
export class CentralServerService {
  ...
  public CheckBillingConnection(): Observable<BillingConnectionStatusResponse> {
    // verify init
    this.checkInit();
    // Execute the REST Service
    return this.httpClient.get<BillingConnectionStatusResponse>(`${this.centralRestServerServiceSecuredURL}/BillingConnection`,
      {
        headers: this.buildHttpHeaders(),
      })
      .pipe(
