...
export class DialogService {
  ...
  public createAndShowOkCancelDialog(title: string, message: string): Observable<ButtonType> {
    // Call
    return this.createAndShowDialog(ConfirmationDialogComponent, Constants.DIALOG_TYPE_OK_CANCEL, title, message);
  }

  public createAndShowOkDialog(title: string, message: string): Observable<ButtonType> {
    // Call
    return this.createAndShowDialog(ConfirmationDialogComponent, Constants.DIALOG_TYPE_OK, title, message);
  }

  public createAndShowYesNoDialog(title: string, message: string): Observable<ButtonType> {
    // Call
    return this.createAndShowDialog(ConfirmationDialogComponent, Constants.DIALOG_TYPE_YES_NO, title, message);
  }

  public createAndShowYesNoCancelDialog(title: string, message: string): Observable<ButtonType> {
    // Call
    return this.createAndShowDialog(ConfirmationDialogComponent, Constants.DIALOG_TYPE_YES_NO_CANCEL, title, message);
  }

  public createAndShowInvalidChangeCloseDialog(title: string, message: string): Observable<ButtonType> {
    // Call
    return this.createAndShowDialog(ConfirmationDialogComponent, Constants.DIALOG_TYPE_INVALID_CHANGE, title, message);
  }

  public createAndShowDirtyChangeCloseDialog(title: string, message: string): Observable<ButtonType> {
    // Call
    return this.createAndShowDialog(ConfirmationDialogComponent, Constants.DIALOG_TYPE_DIRTY_CHANGE, title, message);
  }
