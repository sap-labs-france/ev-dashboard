  ...
  template: `
    <div *ngIf="gridMonitoringData && siteArea; else elseNoGridMonitoring">
      ...
      <div *ngIf="gridMonitoringData.type === GridMonitoringConnectionType.ECOWATT"
        ...
        <app-ecowatt-grid-status [siteArea]="siteArea" [ecowattData]="gridMonitoringData.ecowatt">
        </app-ecowatt-grid-status>
      </div>
...
export class GridStatusCellComponent extends CellContentTemplateDirective implements OnInit {
