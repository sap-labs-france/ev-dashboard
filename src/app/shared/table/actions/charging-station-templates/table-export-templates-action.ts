...
export class TableExportTemplatesAction extends TableExportAction {
  ...
  private exportTemplates(filters: FilterParams, dialogService: DialogService, translateService: TranslateService,
    messageService: MessageService, centralServerService: CentralServerService, router: Router,
    spinnerService: SpinnerService) {
    super.export(filters, 'exported-charging-station-templates.json',
      'templates.dialog.export.title', 'templates.dialog.export.confirm', 'templates.dialog.export.error',
