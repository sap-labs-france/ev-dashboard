...
export interface TableChargingStationsGenerateQrCodeConnectorActionDef extends TableActionDef {
...
export class TableChargingStationsGenerateQrCodeConnectorAction implements TableAction {
  private action: TableChargingStationsGenerateQrCodeConnectorActionDef = {
  ...
  public getActionDef(): TableChargingStationsGenerateQrCodeConnectorActionDef {
    return this.action;
  }

  private generateQRCode(chargingStation: ChargingStation, dialogService: DialogService, translateService: TranslateService,
    messageService: MessageService, centralServerService: CentralServerService, spinnerService: SpinnerService, router: Router,
