...
export interface TableEditSiteActionDef extends TableActionDef {
  action: (siteDialogComponent: ComponentType<unknown>, dialog: MatDialog, data: DialogData, refresh?: () => Observable<void>) => void;
}
...
export class TableEditSiteAction extends TableEditAction {
  ...
  private editSite(siteDialogComponent: ComponentType<unknown>, dialog: MatDialog, data: DialogData, refresh?: () => Observable<void>) {
    super.edit(siteDialogComponent, dialog, data, refresh);
  }
}
