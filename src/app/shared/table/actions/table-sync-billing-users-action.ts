...
export class TableSyncBillingUsersAction implements TableAction {
  ...
  public static openPopup(dialogService: DialogService, translateService: TranslateService, messageService: MessageService, centralServerService: CentralServerService, router: Router) {
